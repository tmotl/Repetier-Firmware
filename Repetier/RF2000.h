...
#define MOTOR_CURRENT                       {145,140,100,55,90}                             // Values 0-255 (126 = ~2A), order: driver 1 (x), driver 2 (y), driver 3 (z), driver 4 (extruder 1), driver 5 (extruder 2)  
#define MOTOR_CURRENT_SILENT                {110,110,90,55,90}      
